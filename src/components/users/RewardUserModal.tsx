...
export const RewardUserModal: React.FC<RewardUserModalProps> = ({
  user,
  open,
  onOpenChange,
  onRewardSent,
  ...
  const [rewardType, setRewardType] = useState<'badge' | 'certificate' | null>(null);
  const [selectedTemplate, setSelectedTemplate] = useState<string>('');
  const [selectedCourse, setSelectedCourse] = useState<string>(course?.id.toString() || '');
