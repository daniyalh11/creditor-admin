...
interface SurveyMCQEditModalProps {
  question: SurveyMCQQuestion;
  onSave: (question: SurveyMCQQuestion) => void;
  onCancel: () => void;
}

export const SurveyMCQEditModal: React.FC<SurveyMCQEditModalProps> = ({
  question,
  onSave,
  onCancel
}) => {
  const [formData, setFormData] = useState<SurveyMCQQuestion>(question);
