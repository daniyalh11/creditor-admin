...
/**
 * A dialog for searching and adding instructors to a course.
 *
 * @param {object} props
 ...
 * @param {(instructorData: { userId: string; name: string; email: string; role: InstructorRole }) => void} props.onAdd - Callback to add the selected instructor.
 */
