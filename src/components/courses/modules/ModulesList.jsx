...
export const ModulesList = ({ 
  ...
  const [selectedModuleForAssessments, setSelectedModuleForAssessments] = useState(null);
  ...
  const getModuleThumbnail = (index) => {
    const thumbnails = [
  ...
  const getModuleCompletion = (moduleIndex) => {
  ...
  const handleViewContent = (unitId) => {
    toast({
