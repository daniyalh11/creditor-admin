...
export const ModernCourseSidebar = ({
  course,
  activeSection,
  onSectionChange,
  onToggle,
  onBackToCourses, // Although not used in this component's JSX, it's a received prop
  isCollapsed
}) => {
  const sidebarItems = [
...
ModernCourseSidebar.propTypes = {
  course: PropTypes.shape({
    ...
    progressionType: PropTypes.oneOf(['open', 'sequential']).isRequired,
  }).isRequired,
  activeSection: PropTypes.string.isRequired,
  onSectionChange: PropTypes.func.isRequired,
  onToggle: PropTypes.func.isRequired,
  onBackToCourses: PropTypes.func.isRequired,
