 ...
 * @property {number} x - The horizontal position (percentage).
 * @property {number} y - The vertical position (percentage).
 * @property {string} label - The title or label for the hotspot.
 * @property {string} description - The descriptive text for the hotspot.
 */

/**
 * @typedef {object} LabeledGraphicContentType
 * @property {string} image - The URL of the main image.
 * @property {Hotspot[]} hotspots - An array of hotspot objects to display on the image.
 * @property {'dots' | 'numbers' | 'letters' | 'icons'} [pointStyle] - The visual style of the hotspot points.
 */

/**
 * A component that displays an image with interactive hotspots.
 *
 * @param {object} props
 * @param {LabeledGraphicContentType} props.content - The data for the labeled graphic.
 */
export const LabeledGraphicComponent = ({ content }) => {
