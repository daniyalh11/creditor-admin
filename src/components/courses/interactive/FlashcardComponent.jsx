 ...
 * @property {string} id
 * @property {FlashcardSide} front
 * @property {FlashcardSide} back
 */

/**
 * @typedef {object} FlashcardContentType
 * @property {'grid' | 'stack'} [displayMode] - The way flashcards are displayed.
 * @property {FlashcardData[]} [cards] - An array of flashcards.
 * @property {FlashcardSide} [front] - Legacy support for a single card's front side.
 * @property {FlashcardSide} [back] - Legacy support for a single card's back side.
 */

/**
 * A component to display interactive flashcards in either a grid or stack layout.
 *
 * @param {object} props
 * @param {FlashcardContentType} props.content - The data for the flashcards.
 */
export const FlashcardComponent = ({ content }) => {
  ...
  const renderSingleCard = (card, index, isStacked = false, stackOffset = 0, isActive = true) => {
        ...
        >
          ...
          >
            ...
            <div className="text-center flex-1 flex flex-col justify-center">
              ...
              {displayMode === 'grid' && cards.length > 1 && (
                <p className="text-xs text-blue-600 mt-2">Card {index + 1} of {cards.length}</p>
              )}
          ...
          >
            ...
            <div className="text-center flex-1 flex flex-col justify-center">
              ...
              {displayMode === 'grid' && cards.length > 1 && (
                <p className="text-xs text-green-600 mt-2">Card {index + 1} of {cards.length}</p>
              )}
