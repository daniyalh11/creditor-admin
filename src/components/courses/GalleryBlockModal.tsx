...
interface GalleryBlockModalProps {
  ...
  onSelect: (galleryType: 'carousel' | '2-column' | '3-column' | '4-column') => void;
}

export const GalleryBlockModal: React.FC<GalleryBlockModalProps> = ({
  open,
  onOpenChange,
  onSelect
}) => {
  const handleSelect = (type: 'carousel' | '2-column' | '3-column' | '4-column') => {
    onSelect(type);
    onOpenChange(false);
  };
