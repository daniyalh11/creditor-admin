...
const CourseCreationForm = ({ courseData }) => {
  ...
  useEffect(() => {
    if (isEdit && courseData) {
      setFormData({
        ...
        categories: courseData.categories || (courseData.category ? [courseData.category] : []) || [],
...
CourseCreationForm.propTypes = {
  courseData: PropTypes.object, // courseData is optional and can be any object
};
