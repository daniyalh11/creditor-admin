...
interface LessonBuilderSidebarProps {
  ...
  onAddTextBlock: () => void;
  onAddStatementBlock: () => void;
  onAddQuoteBlock: () => void;
  onAddListBlock: () => void;
  onAddGalleryBlock: () => void;
  onAddInteractiveBlock: () => void;
  onAddMediaBlock: () => void;
  onAddChartsBlock: () => void;
  onAddDividerBlock: () => void;
  onAddTemplate: (templateType: string) => void;
}

export const LessonBuilderSidebar: React.FC<LessonBuilderSidebarProps> = ({
  activeTab,
  setActiveTab,
  onAddTextBlock,
  onAddStatementBlock,
