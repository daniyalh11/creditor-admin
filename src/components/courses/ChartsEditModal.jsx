  ...
  useEffect(() => {
    if (block) {
      ...
      const initializedBlock = {
        ...
        content: {
          ...blockCopy.content,
          data: blockCopy.content.data && blockCopy.content.data.length > 0
            ? blockCopy.content.data
            : [{ label: '', value: 0 }]
        }
      };
...
ChartsEditModal.propTypes = {
  open: PropTypes.bool.isRequired,
  onOpenChange: PropTypes.func.isRequired,
  block: PropTypes.shape({
    id: PropTypes.string.isRequired,
    type: PropTypes.oneOf(['charts']).isRequired,
    style: PropTypes.oneOf(['bar', 'pie', 'line']).isRequired,
  ...
  }), // Note: `block` can be null, so it is not marked as .isRequired
