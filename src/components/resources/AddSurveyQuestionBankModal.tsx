...
interface SurveyQuestion {
  id: number;
  text: string;
  type: 'mcq' | 'descriptive' | 'rating' | 'yes-no';
  options?: string[];
}

interface AddSurveyQuestionBankModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onBankAdded: (bank: any) => void;
}

export const AddSurveyQuestionBankModal: React.FC<AddSurveyQuestionBankModalProps> = ({
  open,
  onOpenChange,
  onBankAdded
}) => {
