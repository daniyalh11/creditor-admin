...
interface AddGradingScaleModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onScaleAdded: (scale: any) => void;
}

export const AddGradingScaleModal: React.FC<AddGradingScaleModalProps> = ({
  open,
  onOpenChange,
  onScaleAdded
}) => {
  ...
  const removeGradeRange = (id: number) => {
    setGradeRanges(gradeRanges.filter(range => range.id !== id));
  };

  const updateGradeRange = (id: number, field: keyof GradeRange, value: string | number) => {
