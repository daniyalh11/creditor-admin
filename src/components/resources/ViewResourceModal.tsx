...
interface Resource {
  id: number;
  title: string;
  type: 'file' | 'link' | 'badge' | 'certificate' | 'content-template' | 'course-template' | 'grading-scale' | 'page' | 'question-bank' | 'rubric' | 'scorm-package' | 'skills' | 'survey-question-bank';
  url?: string;
  fileName?: string;
  fileSize?: string;
  description?: string;
...
export const ViewResourceModal: React.FC<ViewResourceModalProps> = ({
  open,
  onOpenChange,
  resource
}) => {
