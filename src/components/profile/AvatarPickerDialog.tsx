...
interface AvatarPickerDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (avatarSource: string) => void;
...
export function AvatarPickerDialog({ isOpen, onClose, onSave, currentAvatar }: AvatarPickerDialogProps) {
  ...
  // Set the selected avatar to the current avatar when dialog opens
  useEffect(() => {
  ...
  const handleSave = () => {
    if (selectedAvatar) {
      ...
      setTimeout(() => {
        ...
        // Update header avatar by dispatching a custom event
