          ...
          <div className="space-y-8">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <Label htmlFor="home-enrolled" className="text-sm font-medium text-gray-700">Display animated activity indicators on tiles in Home/Enrolled</Label>
                    <Switch id="home-enrolled" defaultChecked />
                  </div>
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <Label htmlFor="home-teaching" className="text-sm font-medium text-gray-700">Display animated activity indicators on tiles in Home/Teaching</Label>
                    <Switch id="home-teaching" defaultChecked />
                  </div>
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <Label htmlFor="home-groups" className="text-sm font-medium text-gray-700">Display animated activity indicators on tiles in Home/Groups</Label>
            ...
            <Card className="bg-white shadow-sm border border-gray-200 rounded-xl">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4 mt-6">
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <Label htmlFor="instructor-view" className="text-sm font-medium text-gray-700">Enable the activity widget in the instructor view of all courses</Label>
                    <Switch id="instructor-view" defaultChecked />
                  </div>
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <Label htmlFor="learner-view" className="text-sm font-medium text-gray-700">Enable the activity widget in the learner view of all courses</Label>
            ...
            <Card className="bg-white shadow-sm border border-gray-200 rounded-xl">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4 mt-6">
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <Label htmlFor="all-groups" className="text-sm font-medium text-gray-700">Enable the activity widget in all groups</Label>
