...
const LessonEditor = () => {
  ...
  // Mock lesson data with proper state management
  ...
  // Handler to update lesson state
  ...
  const handleSave = () => {
    // Here you would typically save the lesson data to your backend
  ...
  const handleSaveSettings = () => {
    // Specific save handler for settings
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateLesson({ estimatedTime: parseInt(e.target.value) || 0 })}
                      />
                    </div>
                  </div>
                ...
                <div className="space-y-8">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-gray-600 text-sm mb-6">Customize your lesson appearance and details</p>
                    </div>
