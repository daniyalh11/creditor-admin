...
const GroupNewsPage = () => {
  ...
  const [createType, setCreateType] = useState<'post' | 'announcement'>('post');
      ...
      content: (
        <>
          ...
          <ul className="list-disc list-inside space-y-1 my-2">
            ...
            <li><span className="font-semibold text-green-600">&#10004;</span> Level up your financial game &mdash; LIVE!</li>
          </ul>
  ...
  const handleLinkSave = (linkData: { url: string; text: string; title: string; target: string }) => {
    if (textareaRef) {
      const start = textareaRef.selectionStart;
      const end = textareaRef.selectionEnd;
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
            ...
            <DialogContent className="sm:max-w-[600px]">
              ...
              <Tabs value={createType} onValueChange={(value) => setCreateType(value as 'post' | 'announcement')} className="w-full">
