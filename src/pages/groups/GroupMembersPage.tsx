...
const GroupMembersPage = () => {
  ...
  const [newMemberRole, setNewMemberRole] = useState<'learner' | 'instructor' | 'admin'>('learner');
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={newMemberRole} onValueChange={(value: 'learner' | 'instructor' | 'admin') => setNewMemberRole(value)}>
                <SelectTrigger>
