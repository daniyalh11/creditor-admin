...
const Courses = () => {
  ...
  const [courseTab, setCourseTab] = useState<'courses' | 'archived' | 'deleted'>('courses');
  const [courseTypeFilter, setCourseTypeFilter] = useState<'open' | 'sequential'>('open');
