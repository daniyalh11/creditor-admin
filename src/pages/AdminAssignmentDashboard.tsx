...
const AdminAssignmentDashboard = () => {
  ...
  const handleViewResponse = (submission: UserSubmission) => {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select 
                ...
                onValueChange={(value: 'Easy' | 'Medium' | 'Hard') => selectedAssignment && setSelectedAssignment({...selectedAssignment, difficulty: value})}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
