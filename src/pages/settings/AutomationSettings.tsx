...
const AutomationSettings = () => {
  ...
  const handleToggle = (rule: string) => {
    ...
    toast({
      ...
      description: `${rule} has been ${automationRules[rule as keyof typeof automationRules] ? 'disabled' : 'enabled'}.`
    });
  };
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="pt-4 border-t">
            <Button onClick={() => navigate('/admin/automation')} variant="default" className="flex items-center gap-2">
