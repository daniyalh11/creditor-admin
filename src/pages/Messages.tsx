...
const Messages = () => {
  ...
  // Mock data - status properties kept for compatibility but not displayed
  ...
  // Initialize messages for selected contact
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader 
        title="Messages" 
        description="Connect with your peers and instructors"
      />
      
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm" style={{ height: 'calc(100vh - 200px)' }}>
